    ...
    main: {
        ...
        1: {
            ...
            1: {
                ...
                cost: E(1),
                effect: () => player.build.mass_2.amt.add(1).pow(2),
            ...
            2: {
                ...
                cost: E(2),
                effect: () => player.build.mass_3.amt.add(1).pow(2),
                effDesc(x=this.effect()) {
            ...
            8: {
                desc: "  reduce mass upgrade scalings are weaker based on Rage Power.",
                cost: E(1e12),
                effect() {
            ...
            9: {
                ...
                desc: "Stronger power is increased by ^1.25.",
                cost: E(1e28),
            },
            10: {
                unl() { return FORMS.bh.unl() },
            ...
            12: {
                ...
                cost: E(1e105),
                effect() {
                    let ret = player.rp.points.max(1).log10().softcap(200,0.15,0).softcap(600,0.01,0).div(1000).add(1)
                    return ret
                },
                effDesc(x=this.effect()) {
                    return "^"+format(x)+(x.gte(1.2)?" <span class='soft'>(softcapped)</span>":"")
                },
            },
            13: {
                unl() { return player.chal.unl },
            ...
            14: {
                unl() { return player.chal.unl },
                desc: "Super Tickspeed starts 50 later.",
                cost: E('e360'),
            },
            15: {
        ...
        2: {
            ...
            3: {
                desc: "Super tickspeeds scales later based on mass of Black Hole.",
                cost: E(25),
                effect() {
                    let ret = player.bh.mass.max(1).log10().pow(1.5).softcap(5,1/5,0).floor()
                    return ret
                },
                effDesc(x=this.effect()) {
            ...
            7: {
                ...
                cost: E(1e9),
                effect() {
                    let ret = player.bh.mass.add(1)
                    return ret = expMult(ret,0.5)
                },
                effDesc(x=this.effect()) {
            ...
            11: {
                unl() { return player.chal.unl },
                desc: "Mass gain softcap is 15% weaker.",
                cost: E(1e80),
            },
            12: {
                unl() { return player.atom.unl && EVO.amt < 1 },
                desc: "Super Tickspeed scales 15% weaker.",
                cost: E(1e140),
            },
            13: {
                unl() { return player.atom.unl },
            ...
            15: {
                ...
                effect() {
                    ...
                    return hasAscension(0,42) ? tmp.atom.atomicEff[0] : player.atom.atomic.add(1).log(5).softcap(10,0.1,0).softcap(50,0.01,0).floor()
                },
                effDesc(x=this.effect()) {
                    return "+"+format(x,0)
                },
        ...
        3: {
            ...
            4: {
                ...
                cost: E(1e5),
                effect() {
                    let ret = player.build.bhc.amt.pow(0.8).mul(0.1)
                    return ret
                },
                effDesc(x=this.effect()) {
                    return "+"+format(x)+"x"
            ...
            5: {
                desc: "Super Rank starts 15 later.",
                cost: E(1e15),
            },
            6: {
                ...
                get cost() { return EVO.amt >= 2 ? E(1e3) : E(1e30) },
                effect() {
                    if (EVO.amt < 2) return player.atom.atomic.add(1).overflow('10',0.5)
                },
                effDesc(x=this.effect()) {
            ...
            9: {
                desc: "Stronger softcap is 10% weaker.",
                cost: E(1e45),
            },
            10: {
                ...
                cost: E(5e47),
                effect() {
                    let ret = player.ranks.tier.floor()
                    return ret
                },
                effDesc(x=this.effect()) {
        ...
        4: {
            ...
            12: {
                ...
                desc: `Mass gain softcap^4 starts later based on Atom.`,
                cost: E(1e13),
                effect() {
