const RESOURCES_DIS = {
    ...
    qu: {
        ...
        desc: (gs)=>format(player.qu.points,0) + "<br>" + (hasUpgrade('br',8) ? player.qu.points.formatGain(tmp.qu.gain.div(10).mul(gs)) : tmp.qu.gain.gt(0) ? "(+"+format(tmp.qu.gain,0)+")" : `(requires ${formatMass(EVO.amt >= 4 ? "ee12" : "ee9", 0)})`),
